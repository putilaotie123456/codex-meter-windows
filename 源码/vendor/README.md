...
`源码/build.ps1` refuses to build if the bundled binary is absent or its
...
hash together in this file, `源码/build.ps1`, and
`源码/src/CodexBarClient.cs`, then run the full Windows test and package
workflow.
